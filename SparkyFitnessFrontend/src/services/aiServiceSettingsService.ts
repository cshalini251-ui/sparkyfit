...
export const getReportRecommendations = async (reportSummary: any, serviceConfig: AIService | null): Promise<{ diet: string; exercise: string }> => {
  return apiCall('/chat/recommendations', {
    method: 'POST',
    body: { reportSummary, service_config: serviceConfig },
  });
};